				...
				<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
											 ...
											 <li class=""><a href="#section-bar-2" class="wi wi-day-showers "><span>&nbsp;Typhoon name</span></a></li>
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($con, "select * from typhoon_name");
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) :
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-transform:uppercase"><?php echo $row['typ_name']; ?></td>
                                            <?php
									echo '<td>';
									if($row['stat_id'] == 0)
									{
										echo '<span class="label label-success label-rouded" >INSIDE PAR</span>';
									}
									elseif($row['stat_id'] == 1)
									{
										echo '<span class="label label-danger label-rouded" title="">OUTSIDE PAR</span>';
									}
									echo '</td>';
                                    ?>
                                            <td>
                                                <?php echo " <a href='#edit_".$row['typhoon_id']."' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>"; ?>

                                            </td>
                                        </tr>
                                    <?php
                                        include('typhnames.php');
                                    endwhile; ?>
