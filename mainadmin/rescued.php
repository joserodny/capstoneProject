        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li class="tab-current"><a href="#section-bar-1" class="mdi mdi-account-multiple-outline"><span>&nbsp;Rescued reports</span></a></li>
											 <li class=""><a href="#section-bar-2" class="mdi mdi-account-multiple-outline"><span>&nbsp;Rescued person</span></a></li>
                                ...
                                <table id="myTable" class="table table-striped display">
                                    ...
                                    ct.cities as city,
                                    count(res.rescued_id) as rescued,
									COUNT(CASE WHEN UPPER(res.gender) = 'Male' THEN 1 END) Male,
									COUNT(CASE WHEN UPPER(res.gender) = 'Female' THEN 1 END) Female
									FROM city ct
									INNER JOIN rescued res on res.c_id=ct.c_id
                                    where res.statusid=1 GROUP BY ct.cities");
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($con, "select * from rescued
                                    LEFT JOIN city on city.c_id=rescued.c_id
                                    LEFT JOIN users on users.c_id=rescued.c_id

                                    group by rescued.rescued_id");
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) :
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-transform:uppercase"> <?php echo _decrypt($row['name'], $secret); ?>&nbsp<?php echo _decrypt($row['lastname'], $secret); ?> </td>



                                            <td><?php echo $row['age']; ?></td>
                                            <td style="text-transform:uppercase"><?php echo $row['gender']; ?></td>
                                            <td style="text-transform:uppercase"><?php echo $row['cities']; ?></td>

                                            <td>
                                                <?php echo "<a href='#rescued_" . $row['rescued_id'] . "' class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> View</a>"; ?>
