...
<style> select {text-transform:uppercase} </style>
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="#" class="waves-effect"><i class="mdi mdi-bookmark-plus fa-fw"></i> <span class="hide-menu">Add area<span class="fa arrow"></span></span></a>
                      ...
                      <li class="devider"></li>
                      <li> <a href="javascript:void(0)" class="waves-effect"><i class="wi wi-thunderstorm fa-fw"></i> <span class="hide-menu">Add Disaster<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#disaster"><i data-icon="&#xe026;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Disaster</span></a></li>
                            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#typhoon"><i data-icon="&#xe026;" class="wi wi-sleet fa-fw"></i> <span class="hide-menu">Typhoon name</span></a></li>
                        </ul>
   ...
   <li class="devider"></li>
                    <li> <a href="#" class="waves-effect" data-toggle="modal" data-target="#cityadmin"><i class="mdi mdi-account-multiple-plus fa-fw"></i> <span class="hide-menu">Add City admin</span></a> </li>
                    <li class="devider"></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
				  ...
				  <div class="row">
				   <div class="col-md-12 col-lg-4">
                     <button class="btn btn-block btn-info btn-rounded" data-toggle="modal" data-target="#adminacc">Create main admin Account</button> <br>
                    </div>
				...
				$result = mysqli_query($con, "SELECT
                  ...
                  where role='2' order by status asc ");
									...
									<td style="text-transform:uppercase"><?php echo $row['f']; ?> &nbsp; <?php echo $row['m']; ?>&nbsp;<?php echo $row['l']; ?></td>
