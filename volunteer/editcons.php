                                ...
                                <table id="myTable1" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            ...
                                            $result = mysqli_query($con, "select * from constituents where b_id = '$bid' and cons_fid!=0 group by cons_fid");
                                        }
                                        while ($row = mysqli_fetch_array($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <?php  echo "
                                                 <a href='familymember.php?headid=".$row['cons_fid']."' class=' fcbtn btn btn-primary btn-outline btn-1f'>View Family</a>";?>
                                                </td>
                                            </tr>
                                ...
                                <table id="myTable2" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            ...
                                            $result = mysqli_query($con, "select * from constituents where b_id = '$bid' and cons_fid=0");
                                        }
                                        while ($row = mysqli_fetch_assoc($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['cons_lname'], $secret); ?></td>
                                                <td>
                                            <?php echo "<a href='#inedit_".$row['cons_id']."' class='btn btn-info btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>"; ?>
                                            <?php echo "<a href='#behead_".$row['cons_id']."' class='btn btn-primary btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='mdi mdi-account-multiple-plus'></i></a>";?>
                                            <?php echo "<a href='#conedrem_".$row['cons_id']."' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='ti-trash'></i></a>";?>
                                                </td>


                                            </tr>
                                        <?php
                                         include('editindi.php');
                                           endwhile;
