...
<style> select {text-transform:uppercase} </style>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="sttabs tabs-style-bar">
                    <nav>
                        <ul>
                            <li class="tab-current"><a href="#section-bar-1" class="icon-people"><span>&nbsp;Constituents per family</span></a></li>
                            <li><a href="#section-bar-2" class="icon-user"><span>&nbsp;Constituents individual</span></a></li>
                ...
                global $con;
                   ...
                   $sql = "SELECT * FROM users where username = '". $_SESSION['username'] ."'";
                       ...
                       while($row = $query->fetch_assoc()){
                        ...
                        $volid = $row['user_id'];
                       $bid = $row['b_id'];
                $grab = mysqli_query($con, "select * from constituents where cons_stat = '1' and b_id='$bid' and volunteer_id='$volid'");

                if(mysqli_num_rows($grab) > 0)
                {
                echo '<a href="family.php"><button class="btn btn-success btn-rounded waves-effect waves-light " type="button"><span class="btn-label"><i class="icon-plus"></i></span>Add Family member</button> </a>';
                }
                else
                {
                echo '<button class="btn btn-info btn-rounded waves-effect waves-light" type="button" data-toggle="modal" data-target="#fhead"><span class="btn-label"><i class="icon-plus"></i></span>Add Head of the Family</button>';
                }
                       }
                                ...
                                <table id="myTable1" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            ...
                                            $result = mysqli_query($con, "select * from constituents where b_id = '$bid' and cons_stat != '2' and cons_fid!=0 group by cons_fid");
                                        }
                                        while ($row = mysqli_fetch_array($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <?php  echo "
                                                <a href='#edit_".$row['cons_fid']."' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>";?>
                                                </td>
                                            </tr>

                                            <?php    include('constituens.php');     endwhile;  ?>
 ...
 <button class="btn btn-info btn-rounded waves-effect waves-light" type="button" data-toggle="modal" data-target="#individual"><span class="btn-label"><i class="icon-plus"></i></span>Add individual</button>
...
<div>
    &nbsp;
                                ...
                                <table id="myTable2" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            ...
                                            $result = mysqli_query($con, "select * from constituents where b_id = '$bid' and cons_stat != '2' and cons_fid=0");
                                        }
                                        while ($row = mysqli_fetch_assoc($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['cons_lname'], $secret); ?></td>
                                                <td>
                                            <?php echo "<a href='#indi_" . $row['cons_id'] . "' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>"; ?>
                                                </td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">active evacuees</h3>
                        <div class="sttabs tabs-style-bar">
                    <nav>
                        <ul>
                            <li class="tab-current"><a href="#section-bar-1" class="icon-people"><span>&nbsp;Constituents per family</span></a></li>
                                ...
                                <table id="myTable3" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            ...
                                            cons.cons_name as fname,
                                            cons.cons_midname as mname,
                                            cons.cons_lname as lname,
                                            cons.cons_fid as fid,
                                            ev.eva_id as evacuation
                                            FROM evacuees eva
                                            LEFT JOIN constituents cons on eva.cons_id=cons.cons_id
                                            LEFT JOIN evacuations ev on ev.eva_id=eva.eva_id
                                            WHERE eva.eva_id='$vid' and eva.stat_id !=1 and cons.cons_fid!=0 
											group by cons.cons_fid");
                                        ...
                                        while ($row = mysqli_fetch_array($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['fname'], $secret); ?> </td>
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['mname'], $secret); ?></td>
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['lname'], $secret); ?></td>
                                                <td>
                                                <?php  echo "
                                                <a href='#fid_".$row['fid']."' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>";?>
                                                </td>
                                            </tr>

                                            <?php    include('activefam.php');     endwhile;  ?>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) :
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform:uppercase"><?php echo _decrypt($row['lname'], $secret); ?></td>
                                                <td>
                                            <?php echo "<a href='#indi_" . $row['indid'] . "' class='btn btn-danger btn-outline btn-circle btn-lg m-r-20' data-toggle='modal'><i class='fa fa-edit'></i></a>"; ?>
                                                </td>


                                            </tr>
                                        <?php
                                         include('activeindi.php');
                                           endwhile;
