    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li class="tab-current"><a  class="ti-help-alt"><span>&nbsp;Missing</span></a></li>
           ...
           <section id="" class="content-current">
					...
					return openssl_decrypt(substr($message, 24), $encryptionMethod, $secret, 0, $iv);
									...
									$result = mysqli_query($con, "select * from missing where b_id = '$bid' and statusid=1");
									}
									...
									<td>
										<?php echo "<a href='#edit_".$row['missing_id']."' class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> View</a>"; ?>
