    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li class="tab-current"><a  class="icon-people"><span>&nbsp;List of Evacuees</span></a></li>
           ...
           <section id="" class="content-current">
					...
					return openssl_decrypt(substr($message, 24), $encryptionMethod, $secret, 0, $iv);
									...
									<td><?php echo _decrypt($row['fname'],$secret);?></td>
									<td><?php echo _decrypt($row['mname'],$secret);?></td>
									<td><?php echo _decrypt($row['lname'],$secret);?></td>
