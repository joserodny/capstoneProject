...
<div class="modal fade"  id="inedit_<?php echo $row['cons_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="text" style="display: none;" value="<?php echo $row['cons_id']; ?>" name="headid">
                 ...
                 <input class="form-control" type="text" name="editconsadd" value="<?php   $secret = '474MaXCKBtASxDT6hgyU067THgqmnB=='; echo _decrypt($row['cons_add'], $secret); ?>" >
				 <h5></h5>
				 </div>
		...
		<input type="submit" class="btn btn-primary" name="constieditper" value="Update">
			  </div>
			</form>
		</div>
     </div>
...
<div class="modal fade"  id="behead_<?php echo $row['cons_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="text" style="display: none;" value="<?php echo $row['cons_id']; ?>" name="ffammem">
				 <div class="form-group">
                     <h3>You want this person be the head of family ?</h3>
				 </div>
		...
		<input type="submit" class="btn btn-primary" name="conshead" value="Yes">
			  </div>
			</form>
		</div>
     </div>
...
<div class="modal fade"  id="conedrem_<?php echo $row['cons_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="text" style="display: none;" value="<?php echo $row['cons_id']; ?>" name="ffammem">
		...
		<div class="modal-footer">
        <button type="button" class="btn btn-secondary float-left" data-toggle="modal" data-dismiss="modal">No</button>
		<input type="submit" class="btn btn-primary" name="conedrem" value="Yes">
			  </div>
			</form>
		</div>
     </div>
