...
<li class="devider"></li>
        ...
        <div id="page-wrapper">
			...
			<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li class="tab-current"><a href="#section-bar-1" class="mdi mdi-account-multiple-outline"><span>&nbsp;Evacuation Center List</span></a></li>
							...
							<?php
                                    ...
                                    from brgy br
                                    LEFT JOIN evacuations eva on eva.b_id=br.b_id
                                    where br.c_id='$cid'
                                    ");
									...
									<tr>
									  ...
									  <td style="text-transform:uppercase"><?php echo $row['brgyname']; ?></td>
                                ...
                                <?php   include('center.php'); endwhile; ?>
									 </tbody>
                                </table>
                            </div>
                                         </section>
