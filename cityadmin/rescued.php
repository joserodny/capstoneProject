...
<div class="col-lg-4 col-sm-6 col-xs-12">
			<button class="btn btn-block btn-info btn-rounded" data-toggle="modal" data-target="#rescued">Add Rescued</button>
			<br>
			</div>
				...
				<div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li class="tab-current"><a href="#section-bar-1" class="ti-map-alt"><span>&nbsp;Rescued</span></a></li>
					...
					return openssl_decrypt(substr($message, 24), $encryptionMethod, $secret, 0, $iv);
									...
									$result = mysqli_query($con, "select * from rescued where c_id = '$bid'");
									}
									...
									if($row['statusid'] == 0)
									{
										echo '<span class="label label-success label-rouded" >Completely rescued</span>';
									}
									elseif($row['statusid'] == 1)
									{
										echo '<span class="label label-danger label-rouded" title="">Still at rescue center</span>';
									}
									echo '</td>';
                                    ?>

									<td>
										<?php echo "<a href='#edit_".$row['rescued_id']."' class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> View</a>"; ?>
                                        <?php echo "<a href='#updres_".$row['rescued_id']."' class='btn btn-info btn-sm' data-toggle='modal'><span class='ti-pencil-alt'></span> Edit</a>"; ?>
                                    </td>
									</tr>
									<?php
									include('view.php');
